...
public class Driver implements java.sql.Driver {
  ...
  protected Properties loadDefaultProperties() throws IOException {
  ...
  protected static @Nullable String loggerHandlerFile;
   ...
   * method. This functionality is only supported with software.aws.rds.jdbc.postgresql.Driver.
   *
   ...
   * class can be gc'ed if necessary. This functionality is only supported with
   * software.aws.rds.jdbc.postgresql.Driver.
   *
