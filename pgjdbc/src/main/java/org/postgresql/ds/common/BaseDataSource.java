...
public abstract class BaseDataSource implements CommonDataSource, Referenceable {
  ...
  public void setClusterId(String id) {
    PGProperty.CLUSTER_ID.set(properties, id);
  }

  public @Nullable String getClusterInstanceHostPattern() {
    return PGProperty.CLUSTER_INSTANCE_HOST_PATTERN.get(properties);
  }

  public void setClusterInstanceHostPattern(String hostPattern) {
    PGProperty.CLUSTER_INSTANCE_HOST_PATTERN.set(properties, hostPattern);
  }

  public int getClusterTopologyRefreshRateMs() throws PSQLException {
    return PGProperty.CLUSTER_TOPOLOGY_REFRESH_RATE_MS.getInt(properties);
  }

  public void setClusterTopologyRefreshRateMs(int ms) {
    PGProperty.CLUSTER_TOPOLOGY_REFRESH_RATE_MS.set(properties, ms);
  }

  public boolean getEnableClusterAwareFailover() {
    return PGProperty.ENABLE_CLUSTER_AWARE_FAILOVER.getBoolean(properties);
  }

  public void setEnableClusterAwareFailover(boolean enableClusterAwareFailover) {
    PGProperty.ENABLE_CLUSTER_AWARE_FAILOVER.set(properties,enableClusterAwareFailover);
  }

  public int getFailoverClusterTopologyRefreshRateMs() throws PSQLException {
    return PGProperty.FAILOVER_CLUSTER_TOPOLOGY_REFRESH_RATE_MS.getInt(properties);
  }

  public void setFailoverClusterTopologyRefreshRateMs(int ms) {
    PGProperty.FAILOVER_CLUSTER_TOPOLOGY_REFRESH_RATE_MS.set(properties, ms);
  }

  public int getFailoverReaderConnectTimeoutMs() throws PSQLException {
    return PGProperty.FAILOVER_READER_CONNECT_TIMEOUT_MS.getInt(properties);
  }

  public void setFailoverReaderConnectTimeoutMs(int ms) {
    PGProperty.FAILOVER_READER_CONNECT_TIMEOUT_MS.set(properties, ms);
  }

  public int getFailoverTimeoutMs() throws PSQLException {
    return PGProperty.FAILOVER_TIMEOUT_MS.getInt(properties);
  }

  public void setFailoverTimeoutMs(int ms) {
    PGProperty.FAILOVER_TIMEOUT_MS.set(properties, ms);
  }

  public int getFailoverWriterReconnectIntervalMs() throws PSQLException {
    return PGProperty.FAILOVER_WRITER_RECONNECT_INTERVAL_MS.getInt(properties);
  }

  public void setFailoverWriterReconnectIntervalMs(int ms) {
    PGProperty.FAILOVER_WRITER_RECONNECT_INTERVAL_MS.set(properties, ms);
  }

  public boolean getGatherPerfMetrics() {
    return PGProperty.GATHER_PERF_METRICS.getBoolean(properties);
  }
